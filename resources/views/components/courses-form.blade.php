...
<div class="description-container">
    <form class="description-form" action="{{ route('inscription', ['id' => $workshop->id]) }}" method="POST"
        ...
        <div class="form-line">
            ...
            <x-input id="birth_date" class="input-form" type="text" name="birth_date" :value="old('birth_date')" required
                autofocus />
        </div>
        ...
        <div class="form-line">
            ...
            <label class="form-check-label" for="legals">He leído y acepto a Factoría F5, como responsable del
                tratamiento de mis datos con la finalidad de dar respuesta a mi consulta o petición. Y politica de
                privacidad</label>
        </div>
    ...
    <section class="privacy-politics">
        En cumplimiento con la Ley Orgánica 3/2018 de Protección de Datos Personales y Garantía de Derechos Digitales
        así como del Reglamento (UE) 2016/679 de protección de datos personales (RGPD), le informamos que Asociación
        Factoría F5, con domicilio en Calle dels Carders 24, 3º 2ª, 08003 en Barcelona, como responsable del tratamiento
        de sus datos personales, le informamos: Los datos personales facilitados por usted, seran tratados por
        Asociación Factoría F5, con la finalidad de proceder a la correcta prestacioń de los servicios solicitados,
        atender sus consultas y enviarle información relacionada con la entidad que pueda ser de su interés.
        Sus datos no serán comunicados a terceros salvo obligación legal o previa solicitud de su consentimiento y serán
        conservados por un plazo minimo de cinco años. Puede ejercitar sus derechos de acceso, rectificación ,
        supresión, oposición , limitación y portabilidad, en el domicilio Calle dels Carders 24, 3º 2ª, 08003 en
        Barcelona, Barcelona, llamando al número de telef́ono 687493484 o enviando un e-mail a lopd@factoriaf5.org.
        Podrá presentar una reclamación ante la Agencia Española de Protección de Datos si considera que sus datos han
        sido tratados de forma inadecuada.
        <br>
        Tras la publicación de la Ley 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los
        derechos digitales, en el artículo 7 se establece que el tratamiento de los datos personales de un menor de edad
        ...
        tratamiento.
        El tratamiento de los datos de los menores de catorce años, fundado en el consentimiento, solo será lícito si
